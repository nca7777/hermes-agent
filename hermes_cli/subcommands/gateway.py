...
def build_gateway_parser(
    ...
    proxy_parser = subparsers.add_parser(
        ...
        description="Run a local HTTP server that forwards OpenAI-compatible requests "
            ...
            "apps can point at the proxy while it attaches your real credentials. "
            "SUBSCRIPTION_PROXY_KEY is optional on loopback and required for other binds.")
    ...
    proxy_start.add_argument("--provider", default="nous",
        help="Upstream provider: nous, openai-codex, or xai (default: nous). "
            "See `hermes proxy providers`.")
    proxy_start.add_argument("--host", default=None,
        help="Bind address (default: 127.0.0.1). Non-loopback binds require "
            "SUBSCRIPTION_PROXY_KEY with at least 32 non-whitespace characters.")
